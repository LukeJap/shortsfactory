...
The target word count is a pacing target, not a minimum. Do not fail a script
solely because it is below the normal range when the verified story material is
already exhausted. Never request repetition, unsupported detail, or padding to
reach a number.
