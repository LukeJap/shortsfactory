...
# Legacy migration only. AutoCut is disabled by setting AUTO_CUT_AGGRESSION to 0.
...
STANDARD_VIDEO_SPEED = "render/standard_video_speed"
# Legacy migration only. Filters are disabled by setting FX_INTENSITY to 0.
